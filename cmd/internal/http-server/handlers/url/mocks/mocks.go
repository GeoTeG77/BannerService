...
func (_m *URLSaver) SaveContent(idToSave int64, title string, text string, url string, banner_id int) (int64, error) {
	ret := _m.Called(idToSave, title, text, url, banner_id )
	var r0 int64
	var r1 error
	if rf, ok := ret.Get(0).(func(int64, error) (int64, error)); ok {
		return rf(idToSave, r1)
	}
